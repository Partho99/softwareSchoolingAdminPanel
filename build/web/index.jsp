...
<html class="no-js h-100" lang="en">
    ...
    <body class="h-100">
        ...
        <div class="color-switcher animated">
            <h5><% out.print(request.getAttribute("message"));%></h5>
                        ...
                        <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
                            <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                                <div class="d-table m-auto">
                                    ...
                                    <span class="d-none d-md-inline ml-1">Software Schooling DashBoard</span>
                                </div>
                            </a>
                                    ...
                                    <div class="card-body p-0 d-flex">
                                        <div class="d-flex flex-column m-auto">
                                            <div class="stats-small__data text-center">
                                                ...
                                                <h6 class="stats-small__value count my-3"><%=request.getAttribute("posts")%></h6>
                                            </div>
                                    ...
                                    <div class="card-body p-0 d-flex">
                                        <div class="d-flex flex-column m-auto">
                                            <div class="stats-small__data text-center">
                                                ...
                                                <h6 class="stats-small__value count my-3"><%=request.getAttribute("views")%></h6>
                                            </div>
                                            <div class="stats-small__data">
                                    ...
                                    <div class="card-body p-0 d-flex">
                                        <div class="d-flex flex-column m-auto">
                                            <div class="stats-small__data text-center">
                                                ...
                                                <h6 class="stats-small__value count my-3"><%=request.getAttribute("comments")%></h6>
                                            </div>
                                            <div class="stats-small__data">
